...
///
/// \param requests A list of one or more CBATTRequest objects, each representing a request to write the value of a characteristic.
///
...
///
/// \param error The reason the call failed, or nil if no error occurred.
///
